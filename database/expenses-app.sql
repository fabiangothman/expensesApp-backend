...
-- -----------------------------------------------------
-- Table `expenses-app`.`currencies`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `expenses-app`.`currencies` (
  `id` BIGINT(20) NOT NULL,
  `name` VARCHAR(100) NOT NULL,
  `iso_code` VARCHAR(3) NOT NULL DEFAULT 'USD',
...
CREATE TABLE IF NOT EXISTS `expenses-app`.`expense_groups` (
  ...
  INDEX `fk_expense_group_currencies1_idx` (`currency_id` ASC) VISIBLE,
  CONSTRAINT `fk_expense_group_currencies1`
    FOREIGN KEY (`currency_id`)
    REFERENCES `expenses-app`.`currencies` (`id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `expenses-app`.`scheduled_expenses` (
  ...
  `updated_at` TIMESTAMP NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_scheduled_expenses_expenses1_idx` (`expense_id` ASC) VISIBLE,
  CONSTRAINT `fk_scheduled_expenses_expenses1`
